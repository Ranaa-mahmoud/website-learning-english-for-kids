...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const checkAlphabetButton = document.querySelector('.alphabet-exercises .checkAnswer');
    const checkWordButton = document.querySelector('.word-exercises .checkAnswer');
    const checkNumberButton = document.querySelector('.number-exercises .checkAnswer');
...
ScrollReveal().reveal('.alphabet-exercises, .word-exercises,.number-exercises', { 
    duration: 2500, 
    origin: 'bottom', 
    distance: '40px', 
    delay: 500,
...
ScrollReveal().reveal('.exercises-container,.words-container,.numbers-container', { 
    duration: 2700, 
    origin: 'bottom', 
    distance: '50px',
    delay: 400,
